...
namespace TrainingPortal.Client.RoleService {
    ...
    public interface IRoleService {
        ...
        TrainingPortal.Client.RoleService.RoleDto[] GetList();
        ...
        TrainingPortal.Client.RoleService.RoleDto Get(string id, string name);
        ...
        void Update(TrainingPortal.Client.RoleService.RoleDto role);
        ...
        string Create(TrainingPortal.Client.RoleService.RoleDto role);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRoleServiceChannel : TrainingPortal.Client.RoleService.IRoleService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RoleServiceClient : System.ServiceModel.ClientBase<TrainingPortal.Client.RoleService.IRoleService>, TrainingPortal.Client.RoleService.IRoleService {
        ...
        public TrainingPortal.Client.RoleService.RoleDto[] GetList() {
            return base.Channel.GetList();
        }
        
        public TrainingPortal.Client.RoleService.RoleDto Get(string id, string name) {
            return base.Channel.Get(id, name);
        }
        
        public void Update(TrainingPortal.Client.RoleService.RoleDto role) {
            base.Channel.Update(role);
        }
        
        public string Create(TrainingPortal.Client.RoleService.RoleDto role) {
